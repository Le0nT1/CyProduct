...
public class MoleculesToInstances {
	...
	public MoleculesToInstances(String cyp, ArrayList<String> attributes,int depth_neighborAtomType, int depth_neighborAtomDescriptor)
			throws Exception{
		loadCypIdx(cyp);
	...
	public Instances generateTypeOneBondInstances_OneMole(IAtomContainer oneMolecule, ArrayList<String> tempData) throws Exception{
...
//		System.out.println(tempData.get(0));
		//ArrayList<String> tempData = generateTypeOneBondFeatures_OneMole(oneMolecule,depth_neighborAtomType, depth_neighborAtomDescriptor);
